---
title: "Teacher-Other Model"
output: html_notebook
---

Import matrix of original home contacts with 6 age groups.
```{r}
c_orig <- read.csv("~/Desktop/Current Projects/COVID/teacher_SEIR-master/Teacher Matrices R/other_orig.csv", row.names=1)
...
# none = group outside of school environment
...
write.csv(outpt.df, "Other Contact Matrix 14x14_1.csv")
```
